...
<form  class="md:w-1/2 space-y-5" wire:submit.prevent='crearVacante' >
    ...
    <div>
        ...
        <div class="my-5 w-80">
            <!--esto es gracia a que livewire soooporta two way data bulding que significa que cuando envio un dato soporta devolverme un dato tambien aal mismo tiempo por eso se ve la imagen en preview-->
            ...
            @if ($imagen)
                Preview de Imagen:
                <img src="{{ $imagen->temporaryUrl() }}" alt="previewimage">
            @endif
        </div>
